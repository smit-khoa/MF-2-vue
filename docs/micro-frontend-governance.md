...
- CI (`.github/workflows/`) and `CODEOWNERS` not yet created — Layer 4 is documented intent, pending setup.
- Turborepo (`turbo.json`) not yet added — pipeline config to be defined when introduced.
